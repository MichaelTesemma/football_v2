...
#     print(model.summary())
#     model.save(f'saved_model/ak_model{i}')
...
# for i in range(22):
#     model = tf.keras.models.load_model(f"v2/saved_model/ak_model{i}",
...
#     model.save(f"v2/ak_models/ak_model{i}", save_format="tf")
#     print(f'model number {i} is saved')

# for i in range(22):
#     model = tf.keras.models.load_model(f"v2/ak_models/ak_model{i}",custom_objects=ak.CUSTOM_OBJECTS)
...
#     with open('v2/ak_models/stats.txt', 'a') as f:
