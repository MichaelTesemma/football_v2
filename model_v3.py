...
df = pd.read_csv('/home/michael/Desktop/v2/prem_clean_fixtures_and_dataframes/df_for_powerbi_v3.csv')
...
for i in range(20):
    ...
    print(model.summary())
    model.save(f'v2/saved_model3/ak_model_v3{i}')
...
for i in range(20):
    model = tf.keras.models.load_model(f"v2/saved_model3/ak_model_v3{i}",
    ...
    model.save(f"v2/ak_models_v3/ak_model_v3{i}", save_format="tf")
    print(f'model number {i} is saved')

for i in range(20):
    model = tf.keras.models.load_model(f"v2/ak_models_v3/ak_model_v3{i}",custom_objects=ak.CUSTOM_OBJECTS)
    ...
    with open('v2/ak_models_v3/stats.txt', 'a') as f:
        ...
        # /home/michael/Desktop/ff/bin/python /home/michael/Desktop/ff/v2/model_v3.py ; systemctl suspend
